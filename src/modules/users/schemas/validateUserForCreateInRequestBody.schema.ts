...
export const validateUserForCreateInRequestBody = z.object(
  {
    nombre: z
      .string(
    ...
    cedula: z
      .string(
        "El campo 'cedula' es obligatorio y debe ser una cadena de texto.",
      )
    ...
    correo_electronico: z
      ...
      .max(
        100,
        "El campo 'correo_electronico' no puede exceder los 255 caracteres.",
      )
  ...
  'La estructura del cuerpo de la solicitud no es válida. Se requiere un Form Data.',
);
